...
export const CardTarea = ({ tarea, cliente }) => {
    ...
    const handleNavigate = (id) => {
        navigate(
            `/FormTarea?tarea=${id}&cliente=${cliente.name}&estado=${tarea.estadoVisita}&idCliente=${tarea.id_cliente}`
        );
    };
    ...
    return (
        <Stack _hover={{ bg: "blue.50" }} mb="2" className="CardTarea">
            <Flex justify="space-between" onClick={() => handleNavigate(tarea.id)}>
                ...
                <Group>
                    ...
                    <Stack>
                        ...
                        <Text textStyle="xs">
                            correria : <Em>{tarea.nombreCorreria}</Em>
                        </Text>
                        <Group>
                        ...
                        <Portal>
                            ...
                            <Dialog.Positioner>
                                <Dialog.Content>
                                    ...
                                    <Dialog.Body>
                                        <p>
                                            Esto eliminara el registro de la base de datos y no podra
                                            ser recuperado ni reestablecido
                                        </p>
                                    </Dialog.Body>
                                    <Dialog.Footer>
